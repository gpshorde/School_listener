...
public final class Context {
    ...
    public static void setQueryBuilder(org.traccar.database.QueryBuilder queryBuilder) {
    ...
    public static void init(String configFile) throws Exception {
        ...
        if (config.getBoolean("event.enable")) {
                                   System.out.println("**************event.enable***************8");
        ...
        if (config.getBoolean("event.forward.enable")) {
                       System.out.println("**************event***************8"+config.getBoolean("event.forward.enable"));
