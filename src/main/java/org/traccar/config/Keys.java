...
public final class Keys {
    ...
    public static final ConfigKey FORWARD_URL = new ConfigKey(
     ...
     public static final ConfigKey EVENT_FORWORD_URL = new ConfigKey(
            "event.forward.url", String.class);

      public static final ConfigKey EVENT_FORWORD_HEADER = new ConfigKey(
            "event.forward.header", String.class);
    /**
