 ...
 * @author addon10
 */
public class TTteltonika09ProtocolDecoder extends BaseProtocolDecoder{
    ...
    public TTteltonika09ProtocolDecoder(Protocol protocol, boolean connectionless) {
        super(protocol);
...
//                 }
            ...
            case 27:
            case 28:
                System.out.println("temp =====id - 24");
                double tmp = readValue(buf, length, true) * 0.1;
               System.out.println("temp ---------------------"+tmp);
                     int IntValue = (int) tmp;
                position.setTemperature(IntValue);

               // position.set(Position.PREFIX_TEMP + (id - 24+1), readValue(buf, length, true) * 0.1);
                break;
            case 66:
