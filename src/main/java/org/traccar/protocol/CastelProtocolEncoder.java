...
//    }
    ...
    public static ByteBuf encodeContent(long deviceId, ByteBuf content) {

        ByteBuf buf = Unpooled.buffer(0);
        String uniqueId = Context.getIdentityManager().getDeviceById(deviceId).getUniqueId();
