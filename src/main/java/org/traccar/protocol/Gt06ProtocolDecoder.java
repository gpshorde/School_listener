...
//        
//         double speed=UnitsConverter.knotsFromKph(buf.readUnsignedByte());
...
//			boolean ignit=BitUtil.check(flags, 15);
//			if(ignit==true){
...
//            }
//        }
////  System.out.println(" lbs length--------->"+length);
//            position.setObtype("lbs");
...
//        
//          position.setObtype("status");
//
//        int status = buf.readUnsignedByte();
//
//        position.set(Position.KEY_STATUS, status);
//        boolean ignit=BitUtil.check(status, 1);
//		if(ignit==true){
//			//position.set(Event.KEY_IGNITION, BitUtil.check(flags, 1));
//			position.setIgnition(1);
//			position.set("ignition_on", "yes");
...
//            
////            System.out.println("7878 deviceSession------------>"+deviceSession.getDeviceId());
//
...
//            
////            System.out.println("===============START MSG_TIME_REQUEST============================== ");
//
...
//            
////              System.out.println("===============END MSG_TIME_REQUEST============================== ");
//
...
//
//            getLastLocation(position, null);
////            System.out.println("cheking truuuu");
...
//    }
//
//    private Object decodeWifi(Channel channel, ByteBuf buf, DeviceSession deviceSession, int type) throws Exception {
//
//        Position position = new Position();
//          position.setProtocol(getProtocolName());
//          
...
//            System.out.println("calculatedmileage");
//            double mileage = 0.0;
...
//
//            if(last != null) {
//                        System.out.println("in if state last");
//
...
//             System.out.println(".........last_mileage Mileage_____........"+last_mileage);             
//             System.out.println(".........______ttotal_mileagee_____........"+total_mileage);
//
//             
//            position.set("mileage", last_mileage);
//              position.set("total_mileage", total_mileage);
//            }else{
//                                        System.out.println("here for the test");
//
...
//            if (hasGps(type)) {
//                
////                   System.out.println("===============START GPS DECODE============================== ");
//                decodeGps(position, buf, false);
////                 System.out.println("===============END GPS DECODE============================== ");
//            } else {
//                getLastLocation(position, null);
//            }
//
//            if (hasLbs(type)) {
//                
////                 System.out.println("===============START LBS DECODE============================== ");
//                decodeLbs(position, buf, hasStatus(type));
////                System.out.println("===============END LBS DECODE============================== ");
//            }
//
//            if (hasStatus(type)) {
//                
////                System.out.println("===============START STATS DECODE============================== ");
//                decodeStatus(position, buf);
////                 System.out.println("===============END STATS DECODE============================== ");
//            }
//            
//            
//           
...
////                System.out.println("===============START MSG_GPS_LBS_1 DECODE============================== ");
//             double mileage=buf.readUnsignedInt()/1000.0;
//					position.set(Event.KEY_ODOMETER, mileage);
//					position.setMileage(mileage);
////               System.out.println("===============END MSG_GPS_LBS_1 DECODE============================== ");
//            }
//
...
//        }
//        System.out.println("hererrerereee for the checking");
//         calculatedmileage(position);
//                 System.out.println("hererrerereee for the checking");
//
//        sendResponse(channel, false, type, buf.getShort(buf.writerIndex() - 6), null);
...
//
//        DeviceSession deviceSession = getDeviceSession(channel, remoteAddress, null);
//        
////        System.out.println("7979 deviceSession------------>"+deviceSession.getDeviceId());
//        if (deviceSession == null) {
//            return null;
//        }
//        
////        System.out.println("7979 device id ----------not null-----------------");
//
...
//                sendPhotoRequest(channel, pictureId);
//            } else {
//                Device device = Context.getIdentityManager().getDeviceById(deviceSession.getDeviceId());
//                position.set(
...
//        
////          System.out.println("*******************GT06 decode PROTOCOL*************************");
//
...
//
//    private boolean decodeGps(Position position, ByteBuf buf, boolean hasLength) {
//        System.out.println("called decodeGps  ");
//        DateBuilder dateBuilder = new DateBuilder(timeZone)
//                .setDate(buf.readUnsignedByte(), buf.readUnsignedByte(), buf.readUnsignedByte())
//                .setTime(buf.readUnsignedByte(), buf.readUnsignedByte(), buf.readUnsignedByte());
//
//        System.out.println("time set ====>"+dateBuilder.getDate());
//        position.setTime(dateBuilder.getDate());
//
//
//        if (hasLength && buf.readUnsignedByte() == 0) {
...
//           if (BitUtil.check(flags, 14)) {
//			boolean ignit=BitUtil.check(flags, 15);
//               System.out.println("ignit =======================--------->"+ignit);
//
//               if(ignit==true){
//                System.out.println("=======================--------->");
//
//                System.out.println("  ignition_on--------->");
//                System.out.println("=======================--------->");
//
//                //position.set(Event.KEY_IGNITION, BitUtil.check(flags, 1));
//				position.setIgnition(1);
...
//                System.out.println("=======================--------->");
//
//                System.out.println("  ignition_off--------->");
//                System.out.println("=======================--------->");
//
//                position.set("ignition_off", "yes");
//                   position.setTrip(2);
...
//
//    private boolean decodeStatus(Position position, ByteBuf buf) {
//          System.out.println("  decodeStatus--------->");
//
//          position.setObtype("status");
//
//        int status = buf.readUnsignedByte();
...
//        position.set(Position.KEY_STATUS, status);
//        boolean ignit=BitUtil.check(status, 1);
//        System.out.println("=decodeStatus ======================--------->"+ignit);
//
//        if(ignit==true){
//            System.out.println("=======================--------->");
//
...
//    private Position decodeLocationString(Position position, String sentence) {
//
//        System.out.println("decodeLocationString");
//        Parser parser = new Parser(PATTERN_LOCATION, sentence);
//        if (!parser.matches()) {
//            return null;
//        }
...
//
//    private Object decodeBasic(Channel channel, SocketAddress remoteAddress, ByteBuf buf) throws Exception {
//        System.out.println("decodeBasic");
//
//        int length = buf.readUnsignedByte();
//        int dataLength = length - 5;
//        int type = buf.readUnsignedByte();
...
//            if (deviceSession != null && deviceSession.getTimeZone() == null) {
//                deviceSession.setTimeZone(getTimeZone(deviceSession.getDeviceId()));
//        System.out.println("setTimeZone decodeBasic");
//            }
//
//            if (dataLength > 10) {
//                int extensionBits = buf.readUnsignedShort();
...
//            int status = buf.readUnsignedByte();
//            position.set(Position.KEY_ARMED, BitUtil.check(status, 0));
//            System.out.println("HERE WE GET");
//
//            position.set(Position.KEY_IGNITION, BitUtil.check(status, 1));
//            System.out.println("HERE WE GET");
//            position.set(Position.KEY_CHARGE, BitUtil.check(status, 2));
...
//
////            position.set(Position.KEY_ODOMETER, buf.readUnsignedInt());
//                                            System.out.println(" MSG_X1_GPS");
//
//            position.setMileage(buf.readUnsignedInt()/1000);
//
//            position.setNetwork(new Network(CellTower.from(
//                    buf.readUnsignedShort(), buf.readUnsignedByte(),
//                    buf.readUnsignedShort(), buf.readUnsignedInt())));
...
////            if(Context.getConnectionManager() != null ){
////
////                System.out.println("getConnectionManager here"+deviceId);
////                return Context.getConnectionManager().getLastPosition(deviceId);
////            }
////            return null;
////        }
...
//
//            Position last = getLastPosition(position.getDeviceId());
//                        System.out.println("position.getDeviceId()"+position.getDeviceId());
//
//            if(last != null) {
//
//                mileage += DistanceCalculator.distance(position.getLatitude(), position.getLongitude(),
...
//
//            position.setMileage(total_mileage);
//             System.out.println(".........______last_mileage_____........"+last_mileage);
//             System.out.println(".........______total Mileage_____........"+total_mileage);
//
//            position.set("mileage", last_mileage);
//              position.set("total_mileage", total_mileage);
//            }else{
//                             System.out.println("here for the set the mileage in else condition"
//                                     + "");
//
//                   position.setMileage(0);
//            }
...
//            DeviceSession deviceSession, int type, int dataLength) throws Exception {
//
//        System.out.println("org.traccar.protocol.Gt06ProtocolDecoder.decodeBasicOther()");
//            Position position = new Position();
//	    position.setDeviceId(getDeviceId());
//            SocketAddress data = channel.localAddress();
//           //    InetSocketAddress address = (InetSocketAddress) data;
...
//             double mileage=buf.readUnsignedInt()/1000.0;
//					position.set(Event.KEY_ODOMETER, mileage);
//                                                                                    System.out.println(" MSG_GPS_LBS_1");
//
//					position.setMileage(mileage);
//               System.out.println("===============END MSG_GPS_LBS_1 DECODE============================== ");
//            }
//
//            if (type == MSG_GPS_LBS_2 && buf.readableBytes() >= 3 + 6) {
//                System.out.println("===============MSG_GPS_LBS_2============================== ");
//
//                position.set(Position.KEY_IGNITION, buf.readUnsignedByte() > 0);
//                position.set(Position.KEY_EVENT, buf.readUnsignedByte()); // reason
//                position.set(Position.KEY_ARCHIVE, buf.readUnsignedByte() > 0);
...
//
//            getLastLocation(position, dateBuilder.getDate());
//            System.out.println("KEY_IGNITION");
//            position.set(Position.KEY_IGNITION, buf.readUnsignedByte() > 0);
//
//            String data = buf.readCharSequence(buf.readableBytes() - 18, StandardCharsets.US_ASCII).toString();
//            for (String pair : data.split(",")) {
...
//                                    position.setMileage(Integer.parseInt(values[1], 16) * 0.01/1000);
//
//                        break;
//                    case 43:
//                        position.set(Position.KEY_FUEL_LEVEL, Integer.parseInt(values[1], 16) * 0.01);
...
//
//                                                        position.setMileage(buf.readUnsignedIntLE()/1000);
//
//                    break;
//                case 0x33:
//                    position.setTime(new Date(buf.readUnsignedInt() * 1000));
...
//        System.out.println("longitude--------->"+longitude);
        ...
        double speed=UnitsConverter.knotsFromKph(buf.readUnsignedByte() * 2);
        position.setSpeed(speed);
...
//        System.out.println("  decodeStatus--------->");
        ...
        position.set(Position.KEY_STATUS, status);
        boolean ignit=BitUtil.check(status, 1);
//        System.out.println("trupti"+ignit);
        position.setIgnition(1);
        if(ignit==true){
            //position.set(Event.KEY_IGNITION, BitUtil.check(flags, 1));\
//            System.out.println("ignition_on");
...
//            System.out.println("ignition_off");
        ...
        position.set(Position.KEY_BATTERY_LEVEL, buf.readUnsignedByte() * 100 / 6);
//        System.out.println("KEY_BATTERY_LEVEL ====================> " +buf.readUnsignedByte() * 100 / 6);
        position.set(Position.KEY_RSSI, buf.readUnsignedByte());
        position.set(Position.KEY_ALARM, decodeAlarm(buf.readUnsignedByte()));
...
//                System.out.println("forceTimeZone"+forceTimeZone);
                if (!forceTimeZone) {
                    timeZone.setRawOffset(offset * 1000);
                }
...
//            System.out.println("MSG_HEARTBEAT");
            ...
            if (buf.readableBytes() >= 2 + 6) {
                position.set(Position.KEY_BATTERY, buf.readUnsignedShort() * 0.01);
//                System.out.println("KEY_BATTERY_LEVE 2 + 6L");
...
//            position.set(Position.KEY_ODOMETER, buf.readUnsignedInt());
            ...
            position.set(Position.KEY_BATTERY, buf.readUnsignedShort() * 0.01);
//            System.out.println("KEY_BATTERY_LEVE 2 + 6L  * 0.01");
...
//        Position last = getLastPosition(position.getDeviceId());
        Position lastData = getLastPosition(position.getDeviceId());;
        ...
        if(lastData != null) {
            ...
            last_mileage =  mileage * 0.001;
            total_mileage  = lastData.getMileage() + last_mileage;
...
//        System.out.println("7979 device id ----------not null-----------------");
        ...
        if (type == MSG_STRING_INFO) {
            ...
            if (decodeLocationString(position, data) == null) {
                getLastLocation(position, null);
                position.set(Position.KEY_RESULT, data);
                                System.out.println("here we get the MSG_STRING_INFO"+data);
    ...
    private Object decodeExtendedModular(ByteBuf buf, DeviceSession deviceSession) {
        ...
        while (buf.readableBytes() > 6) {
            ...
            switch (moduleType) {
                ...
                case 0x18:
                    position.set(Position.KEY_BATTERY, buf.readUnsignedShort() * 0.01);
//                    System.out.println("KEY_BATTERY_LEVE0x18");
...
//                    System.out.println("setSpeed---------gt06>");
