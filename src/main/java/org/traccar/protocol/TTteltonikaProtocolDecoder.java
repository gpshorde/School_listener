 ...
 * @author addon10
 */
public class TTteltonikaProtocolDecoder extends BaseProtocolDecoder{
    ...
    public TTteltonikaProtocolDecoder(Protocol protocol, boolean connectionless) {
        super(protocol);
...
//                     System.out.println("value 4---------->"+value);
                if(id == 1)
                {
//                     System.out.println("digit input 1---------->"+id);
...
//                        System.out.println("ramp off =  0 ---------------------");
            ...
            case 27:
            case 28:
                System.out.println("temp is here id -24");
            ...
            case 73:
            case 74:
                System.out.println("temp is here id - 71");
