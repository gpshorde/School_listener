...
public class SessionResource extends BaseResource {
    ...
    public User get(@QueryParam("token") String token) throws SQLException, UnsupportedEncodingException {
        ...
        if (userId == null) {
            ...
            if (cookies != null) {
                ...
                for (Cookie cookie : cookies) {
                    System.out.println("getName kukkaa=>"+cookie.getName());
                    if (cookie.getName().equals(USER_COOKIE_KEY)) {
                        System.out.println("if_in=>"+USER_COOKIE_KEY);
                        ...
                        System.out.println("password kukkaa=>"+cookie.getName());
            ...
            if (email != null && password != null) {
                ...
                if (user != null) {
                    ...
                    System.out.println("getName in email=>"+user.getName());
                    userId = user.getId();
                ...
                System.out.println("ripuuuuuuuuuuuuuu=>"+user.getName());
        ...
        if (userId != null) {
            ...
            System.out.println("coooooooooooooooooooooooo userId=>"+userId);
